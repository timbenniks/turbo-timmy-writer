...
- Phase 4/5 migrations `0012_short_lethal_legion.sql` and `0013_calm_tarantula.sql` plus Phase 6 migrations `0014_dazzling_mandarin.sql` and `0015_workable_mysterio.sql` are applied to Neon. Pooled verification on 2026-09-06 found 16 migration records, 19 public tables, the pending-publication guard, 82 canonical articles, and zero remaining test variants/publications. Phase 7 source migration `0016_nasty_nico_minoru.sql` is validated locally but is not applied to Neon.
